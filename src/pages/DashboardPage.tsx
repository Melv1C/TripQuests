...
import { JoinTripFormData, joinTripSchema } from '../lib/schemas/trip';
import {
    getTripsByIds,
...
export const DashboardPage: React.FC = () => {
    ...
    const joinTripMutation = useMutation({
        ...
        onSuccess: (data) => {
            ...
            // Update userData atom with the new trip ID
            if (userData) {
                setUserData({
                    ...userData,
            ...
            return (
                <Alert severity="error" sx={{ my: 2 }}>
                    {tripsError instanceof Error
                        ? tripsError.message
                        : 'Failed to load your trips. Please try again later.'}
                </Alert>
            );
        }
        ...
        if (!tripsData || tripsData.length === 0) {
            return (
                <Typography variant="body2" sx={{ my: 2 }}>
                    You haven't joined any trips yet. Create a new trip or join
                    an existing one using an invite code!
                </Typography>
            );
        }
        ...
        <Container maxWidth="lg">
            <Box sx={{ my: 4 }}>
                ...
                <Typography variant="body1" paragraph>
                    This is your TripQuest dashboard. Here you'll see your trips
                    and upcoming quests.
                </Typography>
                    ...
                    <Grid size={12} sx={{ mt: 2 }}>
                        <Paper elevation={2} sx={{ p: 3 }}>
                            ...
                            <Typography variant="body2" paragraph>
                                Enter a 6-character invite code to join an
                                existing trip.
                            </Typography>
                            ...
                            <form onSubmit={handleSubmit(onSubmitJoinTrip)}>
                                ...
                                {joinTripMutation.isError && (
                                    <Alert severity="error" sx={{ mt: 2 }}>
                                        {joinTripMutation.error instanceof Error
                                            ? joinTripMutation.error.message
                                            : 'An error occurred'}
                                    </Alert>
                                )}
                            </form>
